...
describe('GamesExplorerPageComponent', () => {
  ...
  beforeEach(async () => {
    ...
    api.getBatchAnalysisConfig.and.returnValue(of({ enabled: false }));
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: ImportedGameAnalysisService,
          useValue: {
            analyzeGame: jasmine.createSpy('analyzeGame'),
            progress: signal({
              running: false,
              gameId: null,
              currentPly: 0,
  ...
  it('loads config and facets once and refreshes once per distinct canonical route state', () => {
    expect(api.getBatchAnalysisConfig).toHaveBeenCalledTimes(1);
