  ...
  template: `
    ...
    <main id="main-content">
      ...
      <section id="workflow" class="workflow section-shell" aria-labelledby="workflow-title">
        <div class="section-intro" data-scroll-reveal>
        ...
        <ol class="workflow-steps">
          <li data-scroll-reveal><span>01</span><strong>Import games</strong><p>Bring in recent play and keep analysis current.</p></li>
          <li data-scroll-reveal data-reveal-delay="50"><span>02</span><strong>Find patterns</strong><p>Expose recurring decisions, gaps and tactical misses.</p></li>
          <li data-scroll-reveal data-reveal-delay="100"><span>03</span><strong>Build repertoire</strong><p>Extend courses with continuations you actually meet.</p></li>
          <li data-scroll-reveal data-reveal-delay="150"><span>04</span><strong>Train positions</strong><p>Practise weak lines and high-value decisions.</p></li>
          <li data-scroll-reveal data-reveal-delay="200"><span>05</span><strong>Measure progress</strong><p>See what improved and where to focus next.</p></li>
        </ol>
      </section>

      <section id="capabilities" class="capabilities section-shell" aria-labelledby="capabilities-title">
        <div class="section-intro compact-intro" data-scroll-reveal>
          <p class="eyebrow">FROM DATA TO DECISIONS</p>
          <h2 id="capabilities-title">A practical chess system built around your play.</h2>
        </div>
        <article class="capability">
          <div class="capability-copy" data-scroll-reveal><span class="capability-number">01</span><p class="eyebrow">UNDERSTAND YOUR GAMES</p><h3>See the patterns behind individual results.</h3><p>Review engine analysis, tags, opening assignments, tactical detections and performance trends in one connected history.</p></div>
          <div class="capability-demo games-demo" data-scroll-reveal data-reveal-delay="90"><div class="demo-toolbar"><strong>Recent games</strong><span>Last 3 months</span></div><div class="game-row"><span class="result win">W</span><div><strong>vs. northstar_64</strong><small>Sicilian Defence · 31 moves</small></div><code>91%</code></div><div class="game-row"><span class="result loss">L</span><div><strong>vs. stonebishop</strong><small>French Defence · 42 moves</small></div><code>74%</code></div><div class="game-row"><span class="result draw">D</span><div><strong>vs. quietrook</strong><small>Queen's Gambit · 38 moves</small></div><code>83%</code></div></div>
        </article>
        <article class="capability reverse">
          <div class="capability-copy" data-scroll-reveal><span class="capability-number">02</span><p class="eyebrow">BUILD A PRACTICAL REPERTOIRE</p><h3>Grow courses from positions that occur in real games.</h3><p>Compare your repertoire with your game history, discover where lines end too early and add useful continuations without guessing.</p></div>
          <div class="capability-demo branch-demo" data-scroll-reveal data-reveal-delay="90"><div class="demo-toolbar"><strong>Sicilian · Classical</strong><span>Coverage 68%</span></div><div class="branch-row"><span>e4</span><i></i><span>c5</span><i></i><span>Nf3</span><i></i><strong>Be7<small>14 games</small></strong></div><div class="demo-footer"><span>Most useful next addition</span><strong>9...Be7 continuation</strong></div></div>
        </article>
        <article class="capability">
...
export class LandingPageComponent implements AfterViewInit, OnDestroy {
  ...
  private cleanupScrollReveal?: () => void;
  ...
  ngAfterViewInit(): void {
    ...
    this.cleanupScrollReveal = setupLandingScrollReveal(this.host.nativeElement, browserWindow);
  }

  ngOnDestroy(): void {
    this.cleanupScrollReveal?.();
    this.cleanupScrollReveal = undefined;
  }
}
