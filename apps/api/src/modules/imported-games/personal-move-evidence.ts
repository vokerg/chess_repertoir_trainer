import { OPENING_ANALYSIS_PERSONAL_MOVE_EVIDENCE_POLICY_VERSION } from '@chess-trainer/contracts/imported-games';

export const PERSONAL_MOVE_EVIDENCE_POLICY_VERSION = OPENING_ANALYSIS_PERSONAL_MOVE_EVIDENCE_POLICY_VERSION;
