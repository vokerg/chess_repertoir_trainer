...
const siblingGraph = buildRepertoireGraph([
...
const blackGraph = buildRepertoireGraph([makeLine(3, 'Sicilian', 'BLACK', ['e2e4', 'c7c5'])]);
...
const whiteGraph = buildRepertoireGraph([makeLine(4, 'English', 'WHITE', ['c2c4', 'e7e5'])]);
...
const shortWhiteGraph = buildRepertoireGraph([
...
const conflictGraph = buildRepertoireGraph([
...
const conflicts = getRepertoireConflicts(conflictGraph);
...
const customGraph = buildRepertoireGraph([customLine]);
