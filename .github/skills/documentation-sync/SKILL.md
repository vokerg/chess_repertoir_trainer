...
description: Use when code changes architecture, routes, contracts, queries, workspaces, setup, or agent workflow guidance.
---

# Documentation synchronization

1. Identify the canonical document in `docs/README.md`.
