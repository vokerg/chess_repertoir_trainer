...
- Accounts, Progress, Player Chess Profile, Performance by Rating, Lichess integration, and Appearance: feature-local routes, stores/data access where applicable, computed view state, immutable commands, external templates/styles, and rendered accessibility regression coverage.
