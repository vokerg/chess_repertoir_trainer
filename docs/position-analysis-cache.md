...
- Rich rows store scalar best move/eval and up to three engine lines/PVs. Interactive/free/opening board analysis uses rich depth 18 and MultiPV 3.
...
- Depth 12 rich rows do not satisfy depth 18 interactive requests; the browser reruns Stockfish and rich-saves upgraded depth 18 lines.
