...
- Lab performance-by-rating requests/responses and top-opponents responses are exported from `@chess-trainer/contracts/lab`; the API owns report query/aggregation behavior and Angular owns presentation state rather than duplicate wire DTOs.
